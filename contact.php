			...
			<div class="container">
				...
				<div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarSupportedContent">
					<ul class="navbar-nav">
						...
						<li><a href="contact.php">V-ID</a></li>
					</ul>
				</div>
			</div>
		</nav>
...
<br><br><br><br><br><br><br>
		<div class="form-title-row">
			...
			<h5 style="margin-left:-100px; font-family:calibri">Already have a V-ID? Login <a href="login.php">here</a>.</h5> <br><br>
              ...
              <div class="col-md-6">
				...
				<div class="form-group">
                  <input
                    ...
                    onfocus="this.placeholder = ''"
                    onblur="this.placeholder = 'Enter your profession'"
                    required=""
                  />
                </div>
				...
				<div class="form-group">
                  <input
                    ...
                    id="number"
                    name="number"
                    placeholder="Enter your civil identification or CPF"
                    onfocus="this.placeholder = ''"
                    onblur="this.placeholder = 'Enter your civil identification or CPF'"
                    required=""
                  />
                </div>
